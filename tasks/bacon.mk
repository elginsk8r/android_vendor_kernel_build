...
bacon: $(INTERNAL_OTA_RETROFIT_DYNAMIC_PARTITIONS_PACKAGE_TARGET)
	$(hide) ln -f $(INTERNAL_OTA_RETROFIT_DYNAMIC_PARTITIONS_PACKAGE_TARGET) $(INTERNAL_BACON_PACKAGE)
	$(hide) $(MD5) $(INTERNAL_BACON_PACKAGE) | sed "s|$(PRODUCT_OUT)/||" > $(INTERNAL_BACON_PACKAGE).md5sum
	@echo "Retrofit Package Complete: $(INTERNAL_BACON_PACKAGE)" >&2
